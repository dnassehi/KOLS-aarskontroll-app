...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const updated = await prisma.annualReview.update({
    ...
    data: {
      ...
      responseTestSaba: !!body.responseTestSaba,
      responseTestSama: !!body.responseTestSama,
      postFev1L: body.postFev1L ?? null,
      postFev1PercentPred: body.postFev1PercentPred ?? null,
      postFvcL: body.postFvcL ?? null,
      postFev1Fvc: body.postFev1Fvc ?? null,
      gliAge: body.gliAge ?? null,
      gliSex: body.gliSex ?? null,
      gliEthnicity: body.gliEthnicity ?? null,
      spo2: body.spo2 ?? null,
      ...
      receivesPhysiotherapy: !!body.receivesPhysiotherapy,
      lastRehabYear: body.lastRehabYear ?? null,
      ...
      auditQ1:  body.auditQ1  ?? null,
      auditQ2:  body.auditQ2  ?? null,
      auditQ3:  body.auditQ3  ?? null,
      auditQ4:  body.auditQ4  ?? null,
      auditQ5:  body.auditQ5  ?? null,
      auditQ6:  body.auditQ6  ?? null,
      auditQ7:  body.auditQ7  ?? null,
      auditQ8:  body.auditQ8  ?? null,
      auditQ9:  body.auditQ9  ?? null,
      auditQ10: body.auditQ10 ?? null,
      auditCScore: body.auditCScore ?? null,
